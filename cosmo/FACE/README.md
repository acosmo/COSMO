...
# Known Issues:
 ...
 2. When COSMO Face is running from over HTTPS. Tapping on the face tries to send a request to http://192.168.1.109:1888/ask4, which is HTTP. Firefox, Safari browsers block this as “mixed active content”, resulting in the error. Workaround: Use "face" on Chrome (PC) or Android and allow permission
