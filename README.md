...
3. COSMO speak: Make COSMO speaking. Hands-on tech fun for parents and kids: explore APIs, integrate systems. A basic introduction to Linux, Raspberry Pi, Python and Jupyter Notebook. Requires an old Alexa Speaker. Contact me on [Discord Channel](https://discord.gg/dVgZ73tp6) if you need any help; (check folder [cosmo/senses/speak/](cosmo/senses/speak/README.md)).
